Public Class Testing
    ...
    Private Sub init_UI()
        ...
        For Each ctl As Control In Me.Controls
            ...
            End If
        Next ctl
        Dim login, games, settings, database, game1, game2 As New ToolStripDropDownButton

        login.Text = "Log In"
        games.Text = "Games"
        settings.Text = "Settings"
        database.Text = "Database"
        game1.Text = "Game1asdasdada"
        game2.Text = "Game2"
        game1.Size = New Size(60, 20)
        game2.AutoSize = True
        'tom.DropDownItems.Add(ha)
        'tom.DropDownDirection = ToolStripDropDownDirection.Right
        'ha.Text = "ha"
        'ha.DropDownDirection = ToolStripDropDownDirection.Right
        With games
            .ShowDropDownArrow = False
            .DropDownItems.Add(game1)
            .DropDownItems.Add(game2)
            .Enabled = True
            .Visible = True
        End With
        ...
        AddHandler login.Click, AddressOf Hola
    End Sub
